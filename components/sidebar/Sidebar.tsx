...
export default function Sidebaruser() {
  ...
  return (
    <div className="flex bg-red-50 rounded-2xl flex-col items-center  gap-10 justify-items-stretch  w-full min-h-10 sm:h-full overflow-hidden text-gray-800  border-grey-500 p-0  ">
