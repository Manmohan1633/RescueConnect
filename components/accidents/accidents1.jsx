...
//   }, [Location]);
    ...
    return (
        <div className="flex flex-col h-full border-r-2 border-grey-500  mr-0">
            ...
            <div
                className=" h-full mr-2 mt-3 flex-flex-col bg-white "
                style={{ flex: 3 }}
            >

                {markerData.map((obj) => (<AccidentsDetails tittle={obj.tittle} time={obj.datetime} status={obj.status} loc={[obj.location?.latitude,obj.location?.longitude]} />))}
